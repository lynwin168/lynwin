          ...
          <Row>
            <Col lg={7} md={12}>
              <CardView className={styles.signinFormCardView}>
                  ...
                  <Form.Group className="mb-3">
                    <Form.Control
                      ...
                      {...register("username", {
                        required: {
                          value: true,
                          message: "โปรดระบุ ยูส/เบอร์โทรศัพท์",
                        },
                      })}
                    />
                    {errors?.username && (
                ...
                <a className={classNames(styles.forgetPassword)} target='_blank' rel='noreferrer' href='https://line.me/R/ti/p/@j@926slomw'>
                  ลืมรหัสผ่าน ?
                </a>
                </p>
              </CardView>
            ...
            <Col lg={5} md={12} className={styles.welcomeSection}>
              <div className="text-center position-relative">
                ...
                <p className="mt-3">
                  หากคุณยังไม่มีบัญชี ?
                  <Link href="/signup">
                    <a className={classNames(styles.signup, "ms-2")}>
                      สมัครสมาชิก
                    </a>
                  </Link>
                </p>
